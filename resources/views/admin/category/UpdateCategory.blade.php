                ...
                <body style="overflow: hidden visible;">
                    <div id="page-container" class="flex items-center justify-center h-screen">
                        <div class="bg-white w-full md:w-1/2 p-8 shadow-lg rounded-md">
                            ...
                            <form action="{{route('updateCategoryDATA',$categorie->id)}}" method="get">

                                <div class="mb-4">
                                    <label for="catName" class="text-sm font-semibold text-gray-600">Name</label>
                                    <input type="text" id="catName" name="catName" value="{{ $categorie->name }}"
