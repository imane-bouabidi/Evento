                ...
                <body style="overflow: hidden visible;">
                    <div id="page-container" class="flex items-center justify-center h-screen">
                        <div class="bg-white w-full md:w-1/2 p-8 shadow-lg rounded-md">
                            <h1 class="text-3xl font-bold mb-6">Ajouter Evenement</h1>
                            <form action="{{route('AddEvent')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <label for="acceptation" class="text-sm font-semibold text-gray-600">Acceptation</label>
                                    <select name="acceptation" id="acceptation" class="w-full px-4 py-2 border rounded-md mt-1 focus:outline-none focus:border-indigo-500">
